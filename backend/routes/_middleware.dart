...
final _platformInvoiceRepository = PlatformInvoiceRepository(_pool, _numberSequenceRepository);
...
Handler middleware(Handler handler) {
  return handler
      ...
      .use(provider<PlatformInvoiceRepository>((_) => _platformInvoiceRepository))
